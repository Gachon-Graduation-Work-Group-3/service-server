...
import howmuchcar.infra.dto.OpenAiMessage
import howmuchcar.infra.dto.OpenAiRequest
import howmuchcar.infra.status.OpenAiErrorStatus
...
@Component
class TagGeneratorAdapter : GenerateTagPort {
    ...
    override fun generateTags(description: String): List<String> {
        ...
        client.newCall(request).execute().use { response ->
            if (!response.isSuccessful) {
                ...
                throw RestApiException(OpenAiErrorStatus.ERROR_OPENAI)
            }
